 ...
 */
class AulaFoto extends \ItoSoftware\Base\ModelBundle\Entity\AulaFoto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ItoSoftware\\Base\\ModelBundle\\Entity\\AulaFoto' . "\0" . 'nombre', '' . "\0" . 'ItoSoftware\\Base\\ModelBundle\\Entity\\AulaFoto' . "\0" . 'foto', '' . "\0" . 'ItoSoftware\\Base\\ModelBundle\\Entity\\AulaFoto' . "\0" . 'descripcion', '' . "\0" . 'ItoSoftware\\Base\\ModelBundle\\Entity\\AulaFoto' . "\0" . 'created_at', '' . "\0" . 'ItoSoftware\\Base\\ModelBundle\\Entity\\AulaFoto' . "\0" . 'updated_at', '' . "\0" . 'ItoSoftware\\Base\\ModelBundle\\Entity\\AulaFoto' . "\0" . 'id', '' . "\0" . 'ItoSoftware\\Base\\ModelBundle\\Entity\\AulaFoto' . "\0" . 'aula');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AulaFoto $proxy) {
