 ...
 */
class Municipio extends \ItoSoftware\Base\ModelBundle\Entity\Municipio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ItoSoftware\\Base\\ModelBundle\\Entity\\Municipio' . "\0" . 'codigo', '' . "\0" . 'ItoSoftware\\Base\\ModelBundle\\Entity\\Municipio' . "\0" . 'nombre', '' . "\0" . 'ItoSoftware\\Base\\ModelBundle\\Entity\\Municipio' . "\0" . 'activo', '' . "\0" . 'ItoSoftware\\Base\\ModelBundle\\Entity\\Municipio' . "\0" . 'slug', '' . "\0" . 'ItoSoftware\\Base\\ModelBundle\\Entity\\Municipio' . "\0" . 'created_at', '' . "\0" . 'ItoSoftware\\Base\\ModelBundle\\Entity\\Municipio' . "\0" . 'updated_at', '' . "\0" . 'ItoSoftware\\Base\\ModelBundle\\Entity\\Municipio' . "\0" . 'id', '' . "\0" . 'ItoSoftware\\Base\\ModelBundle\\Entity\\Municipio' . "\0" . 'eventos');
        }
    ...
    public function addEventos(\ItoSoftware\Base\ModelBundle\Entity\Evento $eventos)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addEventos', array($eventos));

        return parent::addEventos($eventos);
    }
    ...
    public function removeHotele(\ItoSoftware\Base\ModelBundle\Entity\Evento $eventos)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeHotele', array($eventos));

        return parent::removeHotele($eventos);
    }
